    ...
    <>
      <section className="terminal-section">
        ...
        <div className="terminal-grid terminal-grid--2">
          <ScoreCard label="Quality Score" score={research?.quality?.score} tone={research?.quality?.score >= 70 ? "positive" : research?.quality?.score < 40 ? "negative" : "neutral"} detail={research?.quality?.label} tooltip={METRIC_TIPS.qualityScore} />
          <div className="terminal-card">
            <div className="terminal-eyebrow">Interpretation</div>
            <p className="terminal-copy">
              Strong businesses usually sustain margins, generate cash, and avoid relying on purely narrative-driven growth.
            </p>
          </div>
        </div>
      </section>
