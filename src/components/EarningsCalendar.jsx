      ...
      <div className="terminal-grid terminal-grid--2">
        <div className="terminal-card">
          ...
          {earningsDate ? (
            ...
            <>
              <div className="terminal-stat" style={{ fontSize: "1rem", color: c.textMuted }}>Not available</div>
          ...
          <div className="terminal-card">
            ...
            <Plot
              ...
              layout={{
                ...
                yaxis: { fixedrange: true, gridcolor: c.borderLight, tickfont: { color: c.textMuted }, tickprefix: "$" },
              }}
